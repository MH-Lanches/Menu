...
export default function App() {
  ...
  const CartContent = (
    <div className="flex h-full flex-col bg-zinc-950/95 p-5 backdrop-blur">
          ...
          <div key={item.id} className="border-b border-zinc-800 pb-3">
            ...
            <div className="mt-2 flex items-center gap-3">
              <button
                ...
                className="h-8 w-8 rounded-full border border-zinc-700 text-zinc-200 transition hover:border-red-400"
              >
                -
              </button>
              ...
              <button
                type="button"
                onClick={() => updateQuantity(item.id, 1)}
                className="h-8 w-8 rounded-full border border-zinc-700 text-zinc-200 transition hover:border-emerald-400"
              >
                +
              </button>
            </div>
      ...
      <button
        ...
        className="mt-4 rounded-xl bg-emerald-500 px-4 py-3 text-sm font-semibold text-zinc-950 transition hover:bg-emerald-400 disabled:cursor-not-allowed disabled:bg-zinc-700 disabled:text-zinc-400"
      >
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      {mode === "shop" && (
        <main className="mx-auto grid w-full max-w-7xl gap-0 md:grid-cols-[1fr_360px]">
          <div>
            <section className="relative overflow-hidden border-b border-zinc-800">
              <img
                ...
                className="h-[280px] w-full object-cover opacity-45 md:h-[340px]"
              />
              ...
              >
                ...
                <p className="mt-3 max-w-xl text-sm text-zinc-200 md:text-base">{settings.slogan}</p>
                <p className="mt-4 text-xs text-zinc-300">Controle total de catálogo, preços e pedidos pelo painel admin.</p>
              </motion.div>
            </section>
            ...
            <section className="px-4 py-5 md:px-8">
              <div className="flex flex-wrap items-center gap-2">
                <input
                  ...
                  className="min-w-56 flex-1 rounded-xl border border-zinc-800 bg-zinc-900 px-3 py-2 text-sm outline-none focus:border-emerald-500"
                />
                ...
                {filteredProducts.map((product) => {
                  ...
                  return (
                    <motion.li
                      ...
                      className="grid grid-cols-[96px_1fr_auto] gap-4 border-b border-zinc-800 pb-4"
                    >
                      <img src={product.image} alt={product.name} className="h-20 w-24 rounded-lg object-cover" />
                      <div>
          ...
          <div className="fixed inset-x-0 bottom-0 z-20 border-t border-zinc-800 bg-zinc-950 p-3 md:hidden">
            <button
              type="button"
              onClick={() => setMobileCartOpen(true)}
              className="flex w-full items-center justify-between rounded-xl bg-zinc-900 px-4 py-3"
            >
              <span className="text-sm text-zinc-300">{cartItems.length} itens no pedido</span>
            ...
            {mobileCartOpen && (
              ...
              >
                <motion.div
                  ...
                  className="absolute inset-x-0 bottom-0 h-[88vh] rounded-t-2xl border-t border-zinc-700"
