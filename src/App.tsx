            ...
            <div className="px-4 py-4 space-y-2">
              ...
              <div className="border-t border-white/10 mt-2 pt-2">
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-orange-500/10 to-red-500/10 hover:from-orange-500/20 hover:to-red-500/20 border border-orange-500/20 hover:border-orange-500/40 rounded-xl transition-all duration-300"
                >
                  <span className="text-lg">⚙️</span>
                  <span className="font-semibold text-orange-400">Painel Admin</span>
                </button>
              </div>
            </div>
          </div>
