...
export type Pedido = {
  id: string;
  numero: number;
  cliente: { nome: string; tel: string; endereco?: string };
  itens: CarrinhoItem[];
  subtotal: number;
  desconto: number;
  taxa: number;
...
const defaultProdutos: Produto[] = [
  {
    ...
    destaque: true, promocao: true, tipo: "simples", ordem: 1, vendidos: 142, avaliacao: 4.9,
  },
  {
    ...
    destaque: true, tipo: "simples", ordem: 2, vendidos: 98, avaliacao: 4.8,
  },
  {
    ...
    tipo: "simples", ordem: 3, vendidos: 76, avaliacao: 4.7,
  },
  {
    ...
    destaque: true, tipo: "meio", ordem: 1, tempoPreparoMin: 30, vendidos: 64, avaliacao: 4.9,
    grupos: [
  ...
  },
  {
    ...
    tipo: "multi", ordem: 1, vendidos: 51, avaliacao: 4.6,
    grupos: [
